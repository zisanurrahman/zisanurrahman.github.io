...
<div class="timeline">
  <div class="timeline-item">
    ...
    <div class="timeline-degree">Doctor of Philosophy, Microbiology</div>
    <div class="timeline-inst">Department of Microbiology, University of Manitoba, Winnipeg, Canada</div>
  </div>
  <!-- Add your MSc / BSc below — copy and paste the block above -->
  <!-- <div class="timeline-item">
    <div class="timeline-year">MSc &middot; 20XX–20XX</div>
    <div class="timeline-degree">Degree name</div>
    <div class="timeline-inst">Institution, City, Country</div>
  </div> -->
  <!-- <div class="timeline-item">
    <div class="timeline-year">BSc &middot; 20XX–20XX</div>
    <div class="timeline-degree">Degree name</div>
    <div class="timeline-inst">Institution, City, Country</div>
  </div> -->
</div>
...
<div class="timeline">
  ...
  <!-- <div class="timeline-item">
    <div class="timeline-year">20XX</div>
    <div class="timeline-degree">Award name</div>
    <div class="timeline-inst">Awarding body</div>
  </div> -->
  <div class="timeline-item">
    <div class="timeline-degree" style="color:var(--muted); font-style:italic; font-weight:400;">Add your awards from CV here</div>
  </div>
</div>
